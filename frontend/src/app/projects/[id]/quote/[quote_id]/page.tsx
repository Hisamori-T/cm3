...
import { Download, Plus, Trash2, ChevronDown, ChevronRight, Pencil, ArrowDownToLine, X } from "lucide-react";
...
function SectionBlock({ section, items, onDeleteSection, onUpdateSection, onUpdateItem, onDeleteItem, onAddItem, saving, sectionSelected, selectedItemIds, onToggleSection, onToggleItem }: SectionBlockProps) {
